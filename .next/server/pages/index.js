...
var router_ = __webpack_require__("YnbB");
...
var external_next_router_ = __webpack_require__("4Q3z");
...
function MeetupItem(props) {
  const router = Object(external_next_router_["useRouter"])();
...
async function getStaticProps() {
  //fetch data from an API
  const client = await external_mongodb_["MongoClient"].connect('mongodb+srv://bUG9e78ulpLnX9OP:bUG9e78ulpLnX9OP@cluster0.ojaqa.mongodb.net/meetups?retryWrites=true&w=majority');
  const db = client.db();
